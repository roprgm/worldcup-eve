...
export function MessageContent({
  ...
  if (from === "user") {
    return (
      <div
        className={cn(
          "max-w-[85%] rounded-2xl rounded-br-md border border-border bg-surface px-4 py-2.5 text-[0.9375rem] leading-relaxed whitespace-pre-wrap text-foreground sm:max-w-[80%]",
          className,
        )}
        {...props}
      />
