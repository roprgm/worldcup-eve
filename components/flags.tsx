...
// the wrong cell. flags-sprite.png is a vendored asset laid out from these codes
// (generated by the origin-fixture sprite script). It's imported (not served
// from /public) so Next emits a content-hashed URL with a long immutable cache.
