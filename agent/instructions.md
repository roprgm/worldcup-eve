...
- `<path team="Argentina" />` — ONE team's road to the final (its likely opponent and stadium each round). Only when the user explicitly asks who a team could face; never for a "chances" question, and never one per team.
