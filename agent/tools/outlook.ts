...
export default defineTool({
  description:
    "How far World Cup teams go. Pass a team for its chances to advance / reach each round / win the cup plus its projected route (likely opponent and stadium each round); a group for its advancement odds; top:N for the title favorites; or slot:<73-104> for who's likely to fill an undecided knockout match. Use odds for a single matchup's win chance. To put it on screen, also write a <path>, <chances>, <slot> or <bracket> tag.",
