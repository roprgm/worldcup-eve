    ...
    "turn.started": () => {
      ...
      return defineInstructions({
        markdown: [
          ...
          `• mode="datetime" — when something happens. Renders a friendly phrase: "today at 6:00 PM", "Thursday at 12:30 PM", "Jul 20 at 1:00 PM", or "in 30 minutes" if very soon. Use for "when/what time does X play".`,
          `• mode="relative" — how long until or since. Renders "in 3 days", "2 weeks ago". Use for "how long till kickoff", "cuánto falta".`,
          `• mode="time" — just the clock time ("at 1:00 PM"). Use when the day is already known from context.`,
