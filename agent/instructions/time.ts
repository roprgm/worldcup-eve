    ...
    "turn.started": () => {
      ...
      return defineInstructions({
        markdown: [
          ...
          `Before stating a kickoff's date or time, call convert_time with the kickoff iso and a time zone — the user's own by default (their IANA zone is in the client context), or the stadium (venue_tz) / a named city if they ask for that. From what it returns, write the day and time yourself, short and natural in your reply language; it's already their local time, so don't name the zone.`,
